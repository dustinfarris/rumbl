defmodule Rumbl.AuthTest do
  ...
  test "authentication_required halts when no current_user exists", %{conn: conn} do
    conn =
      conn
  ...
  test "authentication_required continues when the current_user exists", %{conn: conn} do
    conn =
      conn
